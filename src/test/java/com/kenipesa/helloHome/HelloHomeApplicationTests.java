...
public class HelloHomeApplicationTests {
	@Autowired
	MockMvc mockMvc;
	...
	public void testHomeRoute() throws Exception {
		...
		.andExpect(content().string(containsString("Welcome to HelloHome!")));
	}
	...
	public void testLoginRoute() throws Exception {
		...
		.andDo(print())
		.andExpect(status().isOk())
		.andExpect(content().string(containsString("Please login to your HelloHome! account")));
	}
